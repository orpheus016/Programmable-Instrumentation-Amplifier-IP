...
C {simulator_commands_shown.sym} 1050 -950 0 0 {name=SimulatorNGSPICE
simulator=ngspice
only_toplevel=false 
value="
.param temp=27
...
** Set sources
alter @V3[PULSE] = [ 0.76 0.74 0 $&tfr $&tfr $&ton $&tper 0]
...
write tb_ota_cmos5l_tran.raw

.endc
* ngspice commands
"}
C {simulator_commands_shown.sym} 1660 -320 0 0 {
name=Libs_Ngspice
simulator=ngspice
only_toplevel=false
value="
